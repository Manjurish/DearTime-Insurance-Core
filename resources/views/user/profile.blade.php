                ...
                <form action="{{route('userpanel.dashboard.profile.save')}}" method="post" id="profileForm" >
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <section class="card">
                                <div class="card-header">
                                    <h4 class="card-title">{{__('web/profile.personal_header')}}</h4>
                                </div>
                                        ...
                                        <div class="card-text">
                                            <div class="row">
                                                <div class="col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control required select2" name="nationality">
                                                                @foreach(\App\Country::get() as $region)
                                                                    <option @if($profile->country_id == $region->id) selected @elseif(empty($profile->country_id) && $region->nationality == 'Malaysian') selected @endif data-allowed="{{$region->is_allowed}}" value="{{$region->uuid}}">{{$region->nationality}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label>{{__('web/profile.religion')}}</label>

                                                            <select class="form-control required select2" name="religion">
                                                                    <option @if($profile->religion == 'muslim') selected @endif value="muslim">{{__('web/profile.muslim')}}</option>
                                                                    <option @if($profile->religion == 'non_muslim') selected @endif value="non_muslim">{{__('web/profile.non_muslim')}}</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group" >
                                                            ...
                                                            <input type="text" class="form-control required" name="passport" value="{{$profile->nric}}" placeholder="">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <style>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="hidden" class="d-none" name="gender" value="{{$profile->gender ?? 'male'}}" >
                                                ...
                                                <div class="col-md-6">
                                                    <div class="col-md-12">
                                                        <div class="form-group" >
                                                            <label>{{__('web/profile.full_name')}}</label>

                                                            <input type="text" class="form-control required" name="name" value="{{$profile->name}}" placeholder="{{__('web/profile.full_name')}}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group" >
                                                            ...
                                                            <input type="text" class="form-control required dob" name="dob" value="{{$dob}}" placeholder="{{__('web/profile.dob')}}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group" >
                                                            ...
                                                            <input type="text" class="form-control ped" name="passport_expiry_date" value="{{$passport_expiry_date}}" placeholder="{{__('web/profile.passport_expiry_date')}}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="custom-control custom-switch switch-lg custom-switch-success mr-2 mb-1">
                                                            <p class="mb-1">{{__('web/profile.other_life_insurance')}}</p>
                                                            <input type="checkbox" name="has_other_life_insurance"  @if($profile->has_other_life_insurance == '1') checked @endif value="1" class="custom-control-input" id="has_other_life_insurance">
                                                            <label class="custom-control-label" for="has_other_life_insurance">
                                                                <span class="switch-text-left">{{__('web/profile.yes')}}</span>
                                                                <span class="switch-text-right">{{__('web/profile.no')}}</span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="card-text">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label>{{__("web/profile.residential_address")}}</label>
                                                        <input type="text" class="form-control required" name="address" value="{{$profile->address->address ?? ''}}" placeholder="{{__("web/profile.residential_address")}}">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <section class=" card">
                                <div class="card-header">
                                    <h4 class="card-title">{{__('web/profile.occ_header')}}</h4>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
                                        <div class="card-text">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select data-value="{{$profile->occupationJob->industry->uuid ?? ''}}" class="form-control required select2" name="industry">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select data-value="{{$profile->occupationJob->uuid ?? ''}}" class="form-control required select2" name="job">

                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="income w-100">
                                                    <div class="col-12">
                                                        <div class="">
                                                            <p class="mb-0">{{__('web/profile.personal_income')}} (RM<span id="monthly_personal_income_value">{{$profile->personal_income}}</span>)</p>
                                                            <input type="hidden" name="monthly_personal_income" value="{{$profile->personal_income}}">
                                                            <div class="my-1" id="monthly_personal_income_slider"></div>
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="">
                                                            <p class="mb-0">{{__('web/profile.household_income')}} (RM<span id="monthly_household_income_value">{{$profile->household_income}}</span>)</p>
                                                            <input type="hidden" name="monthly_household_income"  value="{{$profile->household_income}}">
                                                            <div class="my-1" id="monthly_household_income_slider"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <div>
                        <button type="button" class="btn btn-primary mr-1 mb-1 waves-effect waves-light submit-btn">Submit</button>
                    </div>
                </form>
...
@section('myscript')
    ...
    <script>
        ...
        function validate(){
            ...
            var nationality = $("select[name=nationality] option:selected");
            if(nationality.val() == ''){
                Validation.setInvalid(nationality,'@lang('web/auth.required')');
                return false;
            }
            var passport = $("input[name=passport]");
            if(passport.val() == '' || (nationality.text() == 'Malaysian' && !isValidMykad(passport.val(),false))){
            ...
            let passportExpiryDate = $("input[name=passport_expiry_date]");
            if((passportExpiryDate.val() == '' || passportExpiryDate.val().length < 10) && nationality.text() != 'Malaysian'){
                Validation.setInvalid(passportExpiryDate,'@lang('web/auth.required')');
                return false;
            }
            ...
            if(address.val().length > 90){
                Validation.setInvalid(address,'@lang('web/profile.address_max_error')');
                return false;
            }
            ...
            if(industry.val() == '' || industry.val() == null){
                Validation.setInvalid(industry,'@lang('web/auth.required')');
                return false;
            }
            var job = $("select[name=job]");
            if(job.val() == '' || job.val() == null){
                Validation.setInvalid(job,'@lang('web/auth.required')');
                return false;
            }
            return true;
        }
        function submit()
        {
            if(!validate())
                return;
            var hasCharityApplied = "{{$profile->is_charity() ? 'true' : 'false'}}";
            if(hasCharityApplied == 'true' && parseInt($("input[name=monthly_household_income]").val()) >= 3000){
                Swal.fire({
                    title: '{{__('web/profile.charity_exit_title')}}',
                    text: "{{__('web/profile.charity_exit_desc')}}",
                    type: 'warning',
                    ...
                    if (result.value) {
                        $("input[name=charity]").val("1");
                        $("#profileForm").submit();
                    } else {
                        $("input[name=charity]").val("0");
                    }


                })
            }else if(hasCharityApplied == 'false') {
                if (parseInt($("input[name=monthly_household_income]").val()) < 3000) {
                    //eligible
                    Swal.fire({
                        title: '{{__('web/profile.charity_ask_title')}}',
                        text: "{{__('web/profile.charity_ask_desc')}}",
                        type: 'warning',
                        showCancelButton: true,
                        confirmButtonColor: '#3085d6',
                        cancelButtonColor: '#d33',
        ...
        $("select[name=job]").on("select2:opening",function(e){
            if($(this).find("option").length == 0){
                e.preventDefault();
                $("select[name=industry]").select2("open");
            };
        });
        <?php     
        $dob_min = \Carbon\Carbon::now()->subYears(65);
        $dob_max = \Carbon\Carbon::now()->subYears(16);
        ...
        var personal = $("input[name=monthly_personal_income]").val();


        var household = $("input[name=monthly_household_income]").val();


        var monthly_household_income_slider = document.getElementById('monthly_household_income_slider');
        noUiSlider.create(monthly_household_income_slider, {
            start: 0,
            connect: [true, false],
            behaviour: 'drag',
            step : 100,
        ...
        var monthly_personal_income_slider = document.getElementById('monthly_personal_income_slider');
        noUiSlider.create(monthly_personal_income_slider, {
            start: 0,
            step : 100,
        ...
        monthly_household_income_slider.noUiSlider.on('update', function (values, handle) {
            var value = Math.round(values[0]);
            $("#monthly_household_income_value").html(value == 10001 ? '10k+' : value);
            $("input[name=monthly_household_income]").val(value);

            var personal = $("input[name=monthly_personal_income]").val();
            if(personal > value){
                monthly_personal_income_slider.noUiSlider.set([value]);
            }
        });
        monthly_personal_income_slider.noUiSlider.on('update', function (values, handle) {
            var value = Math.round(values[0]);
            $("#monthly_personal_income_value").html(value == 10001 ? '10k+' : value);
            $("input[name=monthly_personal_income]").val(value);

            var household = $("input[name=monthly_household_income]").val();
            if(household < value){
                monthly_household_income_slider.noUiSlider.set([value]);
            }
        });
        monthly_personal_income_slider.noUiSlider.set([personal]);
        monthly_household_income_slider.noUiSlider.set([household]);
    </script>
    <script>
        $(".gender-selector").on("click",function(e){
            ...
            if($(this).data('value') == 'male')
                $('input[name=gender]').val('male').trigger('change');
            else
                $('input[name=gender]').val('female').trigger('change');
        ...
        $("select[name=nationality]").on("change",function (e) {
            var is_allowed = $(this).find(":selected").data('allowed') == '1';
            if(!is_allowed){
                $("select[name=nationality]").val("{{ \App\Country::where("nationality","Malaysian")->first()->uuid }}").trigger('change');
                return Swal.fire({
                    title: '{{__('web/profile.not_allowed_country_title')}}',
                    text: '{{__('web/profile.not_allowed_country_desc')}}',
                    type: 'error',
            ...
            changeNric($("select[name=nationality] option:selected").text());
        });
        $("input[name=dob]").on("change",function (e) {
            var passport = $("input[name=passport]");
            var nationality = $("select[name=nationality] option:selected");
            if(passport.val() != '' && nationality.text() == 'Malaysian'){
                Swal.fire({
            ...
            $.get("{{route('wb-api.initPostRegisterIndividual')}}",{},function (res) {
                if(res.status == 'success'){
                    ...
                    if($("select[name=industry]").data('value') != '') {
                        ...
                        $("select[name=industry]").val(val).trigger('change');
                    }else{
                        $(".loading").hide();
                    }
                    ...
                    if($("select[name=state]").data('value') != '') {
                        ...
                        $("select[name=state]").val(val).trigger('change');
                    }else{
                        $(".loading").hide();
                    }
                }
        ...
        $("select[name=state]").on("change",function(e){
            if($(this).val() =='' || $(this).val() ==null)
                return;
            $.get("{{asset('api/tools/getStateInfo')}}",{id:$(this).val()},function(res){
                if(res.status == 'success'){
                    ...
                    if($("select[name=city]").data('value') != '') {
                        ...
                        $("select[name=city]").val(val).trigger('change');
            ...
            $.get("{{asset('api/tools/getStateInfo')}}",{id:$(this).val()},function(res){
                ...
                if(res.status == 'success'){
                    ...
                    if($("select[name=zip_code]").data('value') != '') {
                        ...
                        $("select[name=zip_code]").val(val).trigger('change');
        ...
        $("select[name=industry]").on("change",function(e){
            if($(this).val() =='' || $(this).val() ==null)
                return;
            // var hideIncome = ["180","312","166","165","277"];
            // if(hideIncome.indexOf($(this).val()) != -1){
            //     $(".income").hide();
            //     monthly_personal_income_slider.noUiSlider.set([0]);
            //     monthly_household_income_slider.noUiSlider.set([0]);
            // }else{
            //     $(".income").show();
            // }
            $.get("{{route('wb-api.getIndustryJobsList')}}",{
                industry:$(this).val(),
                ...
                if(res.status == 'success'){
                    ...
                    if($("select[name=job]").data('value') != '') {
                        ...
                        $("select[name=job]").val(val).trigger('change');

                    }else{
                        $(".loading").hide();
                    }
                    if(res.data.length == 1){
                        $("select[name=job]").val(res.data[0].uuid).trigger('change');
                    }
