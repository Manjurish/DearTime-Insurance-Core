                                                                ...
                                                                @else
                                                                    @foreach($data as $key=>$row)
                                                                        <tr @if($key%2==0)class="odd"@endif>
                                                                            ...
                                                                            <td>{{ $row['doc']['name'] }}</td>
                                                                            <td>
                                                                                @foreach($row['match_types'] as $matchType)
                                                                                    {{ $matchType }} <br>
                                                                                @endforeach
                                                                            </td>
                                                                            <td>{{ $row['match_status'] }}</td>
                                                                            <td>{{ $row['score'] }}</td>
                                                                            <td><a data-toggle="modal" data-target="#screening-details-modal-{{$key}}"><i class="feather icon-clipboard"></i></a></td>
                                                                        </tr>
                                                                        @include('admin.screening.details_modal')
                                                                    @endforeach
                                                                @endif
