                                ...
                                <div class="card-body">
                                    ...
                                    <form method="post" action="{{ route('admin.password.email') }}">
                                        ...
                                        <fieldset class="form-label-group form-group position-relative has-icon-left">
                                            <input type="text" class="form-control @error('email') is-invalid @enderror" name="email" id="user-name" placeholder="Email Address" required="">
                                        ...
                                        <div class="float-md-left d-block mb-1">
                                            <a href="{{route('admin.auth.login')}}" class="btn btn-outline-primary btn-block px-75 waves-effect waves-light">Back to Login</a>
                                        </div>
