...
<script>
    ...
    function validate(){
        ...
        if(!Validation.validateEmail(email.val()) && (email.val()).length < 10 ){
                                ...
                                <div class="card-body pt-1">
                                    <form action="{{route('login')}}" method="post" id="loginForm">
                                        ...
                                        <fieldset class="form-label-group form-group position-relative has-icon-left">
                                            <input type="text" class="form-control @error('email') is-invalid @enderror" name="email" id="user-name" placeholder="@lang('web/auth.username')">
                                     ...
                                     {{--    <a href="route }}('register')}}" class="btn btn-outline-primary float-left btn-inline waves-effect waves-light">@lang('web/auth.register')</a> --}}
